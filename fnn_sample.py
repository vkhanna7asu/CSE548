...
"""
"""
Updated on 28th May by Varisha Khanna
"""
########################################
...
while 1:
    Scenario = input ('Enter the scenario to run, a, b or c:')
...
X_train, y_train = dp.get_processed_data(TrainingData, './categoryMappings/')
X_test, y_test = dp.get_processed_data(TestingData, './categoryMappings/')
